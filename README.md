...
4. Подготовка к запуску  
    ...
    ....и.т.д.
    В файле datasource.properties заменить значения имени и пароля с test на root. Скопировать значение url из 4 строки. 
    Кликнуть справа по вертикальной вкладке Database. В открывшемся окне нажать на "+". В выпадающем списке выбрать Data Source - MySQL.
    Вставить в поле скопированный url, пользователь и пароль - root. Нажать Test Connection. Должна появится зелёная галочка. 
