...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        writingBanService.save(new WritingBan(user, BanType.ON_COMMENTS, LocalDateTime.of(2020, 11, 28, 19, 10, 0)));
        writingBanService.save(new WritingBan(user, BanType.ON_FORUM_MESS, LocalDateTime.of(2020, 11, 28, 19, 10, 0)));
